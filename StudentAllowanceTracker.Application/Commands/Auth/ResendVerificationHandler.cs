...
namespace StudentAllowanceTracker.Application.Commands.Auth
{
    public class ResendVerificationHandler : IRequestHandler<ResendVerificationCommand, Result<string>>
    {
        ...
        public ResendVerificationHandler( UserManager<AppIdentityUser> userManager,IEmailVerificationCodeRepository codeRepo,ICodeGenerator codeGenerator,IEmailService emailService)
        {
